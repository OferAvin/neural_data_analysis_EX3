...
function build_fig(Block,has_target,target,non_target,target_color,non_target_color,num_of_trail, x_vec,y_vec,fontsize)
    shapes_num = Block.set_size;
    if num_of_trail==1
        axis off
        instaction_for_first_trail(target,Block.condition,fontsize);
    end
